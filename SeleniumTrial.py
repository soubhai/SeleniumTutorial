...
driver.set_page_load_timeout(100)
driver.find_element_by_name("session_password").send_keys("LinSoubhai300")
driver.set_page_load_timeout(100)
driver.find_element_by_css_selector("btn__primary--large from__button--floating").send_keys(Keys.ENTER)
